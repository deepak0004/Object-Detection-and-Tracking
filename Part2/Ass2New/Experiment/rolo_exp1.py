...
class ROLO():
	...
	def __init__(self):
		...
		self.rolo_weights_dir = "/home/sharat/Documents/assignment2_new/ROLO/weights/train"
		self.rolo_weights_intermediate_dir = "/home/sharat/Documents/assignment2_new/ROLO/weights/train/intermediate"
		...
		self.rolo_weights_dir += "model_step6_exp1.ckpt"
		self.rolo_weights_intermediate_dir += "model_step6_exp1.ckpt"

...
class Detector(object):
    def __init__(self, net, weight_file):
        ...
        self.saver.restore(self.sess, 'save.ckpt-10000')
        #self.saver = tf.train.import_meta_graph('save.ckpt-10000.meta')
        #self.saver.restore(self.sess, 'save.ckpt-10000')
        graph = tf.get_default_graph()
        print(graph)
        layer = graph.get_tensor_by_name('yolo/conv_2/weights:0')
        print(self.sess.run(layer))
